...
**Version**: 4.7 (Inklusive Kimi K3 API Upgrade mit 2M+ Context & Caching)  
...
2. **100% Neue Chinesische KI-Modelle (Juli 2026)**: Sämtliche autonomen Laufzeit-Agenten im fertigen Programm greifen **ausschließlich** auf chinesische APIs der Generation Juli 2026 zu: **DeepSeek-V4**, **Kimi K3** (2M+ Tokens & Context Caching für Hemerotheken), **GLM-5** und **Qwen 3**.
...
9. **Kontextuelle Text- & Archiv-Analyse**: Tiefenrecherche in spanischen Amtsblättern (BOE, DOGV, BOP Alicante/Valencia/Castellón), Zeitungsarchiven (*Hemerotecas*), Kataster-Daten und valencianischen Heimatblogs via **Kimi K3 API & GLM-5 API**.
...
graph TD
    ...
    ArchiveDB --> KimiAgent["🤖 Kimi K3 / GLM-5 KI-Agenten"]
...
| **Hemeroteca Digital BNE** | Historisches Zeitungsarchiv | Digitales Nationalarchiv aller spanischen Zeitungen seit dem 19. Jahrhundert. | Der **Kimi K3 Agent (2M+ Tokens & Caching)** durchsucht Millionen Zeitungsseiten nach Bränden, Tragödien, Insolvenzen und Todesfällen. |
| **BOE & DOGV Amtsblätter** | Staatliches & Regionales Rechtsarchiv | Offizielle Amtsblätter für Spanien (*BOE*) und die Region Valencia (*DOGV*). | **GLM-5 / Kimi K3** recherchieren nach Zwangsversteigerungen (*Subastas Públicas*), Enteignungen und Konkursen. |
...
graph TD
    ...
    subgraph CloudAPIs ["🇨🇳 Laufzeit-Anwendung (100% Chinesische Cloud APIs Juli 2026)"]
        ...
        E["📜 Agent 3: Historiker-Investigator"] -->|API Call| F["Kimi K3 API (2M+ Context & Caching) & GLM-5 API ($0.10 - $0.12 / 1M)"]
...
4. **📜 Agent 3: Historiker-Investigator & Long-Context Archiv-Miner**:
   - **Modell**: **Kimi K3 API (Moonshot AI)** & **GLM-5 API (Zhipu AI)**.
   - **Warum Kimi K3?** Kimi K3 bietet ein riesiges **2 Million+ Tokens Kontextfenster** und **Context Caching** (bis zu 80 % Ersparnis bei wiederkehrenden Dokumenten!). Es liest komplette jahrzehntealte Zeitungsarchive (*Hemerotecas*), mehrstündige YouTube-Transkripte und dicke spanische Amtsblätter (BOE/DOGV) in einem einzigen Durchgang!
...
| **Historiker & Archive** | **Kimi K3 API** | Moonshot AI (`api.moonshot.cn`) | $0.12 (Cached: ~$0.03) | $0.24 | 2 Mio.+ Tokens Kontextfenster & Context Caching für große Zeitungsarchive & Transkripte. |
...
- **10 Standorte scannen & recherchieren**: **~ 0,01 € (1 Cent durch Caching!)**
- **100 Standorte scannen & recherchieren**: **~ 0,10 € (10 Cent!)**
- **1.000 Standorte scannen & recherchieren**: **~ 1,00 € (1 Euro!)**
...
# EMPFOHLEN: OpenRouter.ai Aggregator (1 Key für alle Modelle)
OPENROUTER_API_KEY="sk-or-v1-ihr-openrouter-schluessel-hier"

# ALTERNATIV: Einzeldirekte Cloud-APIs (Stand Juli 2026)
DEEPSEEK_API_KEY="sk-ihr-deepseek-schluessel-hier"
KIMI_API_KEY="sk-ihr-kimi-k3-schluessel-hier"
GLM_API_KEY="ihr-glm5-schluessel-hier"
QWEN_API_KEY="sk-ihr-qwen3-schluessel-hier"

ORCHESTRATOR_MODEL="deepseek-v4"
LONG_CONTEXT_MODEL="kimi-k3"
...
- **Kimi K3 API**: Moonshot AI Long-Context Modell (2 Mio.+ Tokens & Caching) für große Zeitungsarchive (*Hemerotecas*) & Transkripte.
