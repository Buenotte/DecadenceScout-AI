...
const ALL_SPOTS = [
  ...
  {
    id: 1,
    name: 'Sanatorio de Aigües de Busot',
    lat: 38.5038, lon: -0.4124,
    province: 'Alicante', type: 'Sanatorium / Thermalbad Ruine',
    status: 'KNOWN_HISTORIC_SITE',
    year: 1898, built_area: '2.400 m²',
    catastro_ref: '03031A004000120000WX',
    isIllustration: true,
    image: 'https://images.unsplash.com/photo-1518780664697-55e3ad937233?auto=format&fit=crop&w=800&q=80',
    source_url: 'https://es.wikipedia.org/wiki/Ba%C3%B1os_de_Busot',
    history: 'Ehemaliges Luxus-Thermalbad und Tuberkulose-Klinik für den europäischen Adel, erbaut 1898 auf dem Berg Busot bei Alicante. Im Spanischen Bürgerkrieg als Lungenheilstätte genutzt, nach 1975 aufgegeben. Maurische Bogengänge und Marmorthermen sind noch erhalten.',
    risk: 'MITTEL',
    ndvi: 0.58, ndwi: 0.12,
    youtube_script: {
      hook: 'Der vergessene Palast der Kranken: Sanatorio Aigües de Busot.',
      act1: '1898: Europäischer Adel reist nach Alicante zur Thermalkur.',
      act2: '1936: Bürgerkrieg – Luxusbad wird zum Militär-Lazarett.',
      act3: 'Heute: Maurische Bogengänge verwittern in der Bergeinsamkeit.'
    },
    safety_info: {
      structural: 'Teileinsturz der Decken. Vorsicht im Obergeschoss.',
      legal: 'Gemeindeland Busot. Außenbesichtigung möglich.',
      equipment: 'Helm & festes Schuhwerk empfohlen.'
    }
  },

  // ─── ARBEITERKOLONIEN & PALÄSTE ──────────────────────────────────────────────
  {
    id: 2,
    name: 'Colonia de Santa Eulalia (Sax)',
    lat: 38.5694, lon: -0.8545,
    province: 'Alicante', type: 'Historische Arbeitersiedlung & Palast',
    status: 'KNOWN_HISTORIC_SITE',
    year: 1887, built_area: '12.500 m²',
    catastro_ref: '03123A001000450000QW',
    isIllustration: true,
    image: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=800&q=80',
    source_url: 'https://es.wikipedia.org/wiki/Colonia_de_Santa_Eulalia',
    history: 'Autarke Bergarbeiterkolonie mit eigenem Grafenpalast, Theater, Schule und Krankenhaus. Zwischen 1887 und 1920 vollständig bewohnt, nach Schließung der Silbermine und Tod des letzten Erben komplett verlassen. Heute Denkmal Bien de Interés Cultural.',
    risk: 'NIEDRIG',
    ndvi: 0.49, ndwi: 0.05,
    youtube_script: {
      hook: 'Eine ganze Stadt in der Wüste – verlassen seit 100 Jahren.',
      act1: '1887: Graf baut seine eigene Miniaturstadt für die Minenarbeiter.',
      act2: '1920: Silber geht aus – die letzte Familie verlässt die Kolonie.',
      act3: 'Heute: Palast, Theater und Kirche stehen unberührt in der Steppe.'
    },
    safety_info: {
      structural: 'Gut erhaltene Steinbauweise. Sicher für Besichtigung.',
      legal: 'BIC-Denkmal. Außenbesichtigung offiziell möglich.',
      equipment: 'Wanderschuhe & Wasser (kein Schatten).'
    }
  },
  ...
  {
    id: 3,
    name: 'Sanatorio de Fontilles (Vall de Laguar)',
    lat: 38.7842, lon: -0.0758,
    province: 'Alicante', type: 'Historisches Sanatoriumsdorf',
    status: 'UNCHARTED_NEW_DISCOVERY',
    year: 1909, built_area: '8.400 m²',
    catastro_ref: '03138A003000990000ZZ',
    isIllustration: true,
    image: 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&w=800&q=80',
    source_url: 'https://es.wikipedia.org/wiki/Sanatorio_de_Fontilles',
    history: 'Historisches Lepra-Sanatorium, 1909 von Jesuiten als komplett autarkes Dorf erbaut – mit eigenem Krankenhaus, Kapelle, Wohnpavillons, Gärten und Weinbergen. Seit den 1980ern werden Pavillons schrittweise aufgegeben. National als BIC registriert.',
    risk: 'NIEDRIG',
    ndvi: 0.62, ndwi: 0.14,
    youtube_script: {
      hook: 'Das isolierte Lepra-Bergdorf von Fontilles – 1909 bis heute.',
      act1: '1909: Jesuitenmission baut autarkes Sanitätsdorf im Gebirge.',
      act2: '1980: Lepra gilt als besiegt – Pavillons werden aufgegeben.',
      act3: 'Heute: Verlassene Pavillons zwischen blühenden Orangenhainen.'
    },
    safety_info: {
      structural: 'Massive Natursteingebäude, sehr gut erhalten.',
      legal: 'Stiftungseigentum. Außenanlage frei zugänglich.',
  ...
  {
    id: 4,
    name: 'Fábrica Textil – Alcoi (Manchester Spaniens)',
    lat: 38.6981, lon: -0.4752,
    province: 'Alicante', type: 'Verlassene Textilfabrik',
    status: 'KNOWN_HISTORIC_SITE',
    year: 1888, built_area: '11.000 m²',
    catastro_ref: '03009A007000880000KK',
    isIllustration: true,
    image: 'https://images.unsplash.com/photo-1565008447742-97f6f38c985c?auto=format&fit=crop&w=800&q=80',
    source_url: 'https://es.wikipedia.org/wiki/Barrio_del_Molinar',
    history: 'Monumentale viktorianische Textilfabrik im Quartier El Molinar, Alcoi. Im 19. Jh. war Alcoi das "Manchester Spaniens" – größtes Industriezentrum der Iberischen Halbinsel. Riesige englische Webmaschinen aus Stahl rosten in den Hallen. Seit 1978 stillgelegt.',
    risk: 'MITTEL',
    ndvi: 0.52, ndwi: 0.09,
    youtube_script: {
      hook: 'Das Manchester Spaniens – verlassene Textilfabrik in Alcoi.',
      act1: '1888: Alcoi liefert Uniformstoffe für die spanische Armee.',
      act2: '1978: Billigtextilien aus Asien stoppen die Produktion.',
      act3: 'Heute: Englische Webmaschinen rosten in viktorianischen Backsteinhallen.'
    },
    safety_info: {
      structural: 'Stahlkonstruktion, Böden teilweise durchgerostet.',
      legal: 'Stadtarchiv Alcoi prüft Restaurierung.',
      equipment: 'Schutzschuhe mit Stahlkappe & Helm.'
    }
  },
  {
    id: 5,
    name: 'Fábrica de Harinas Orihuela (Mehlmühle, 1905)',
    lat: 38.0912, lon: -0.9489,
    province: 'Alicante', type: 'Verlassene Getreidemühle / Fabrik',
    status: 'KNOWN_HISTORIC_SITE',
    year: 1905, built_area: '6.100 m²',
    catastro_ref: '03099A006000330000HH',
    isIllustration: true,
    image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=800&q=80',
    source_url: 'https://es.wikipedia.org/wiki/Orihuela',
    history: 'Riesige dampfbetriebene Getreidemühle von 1905 am Segura-Fluss in Orihuela. Sechs Etagen mit eisernen Mahlwerken noch vorhanden. In den 1960ern stillgelegt. BOE-Eintrag als Industriedenkmal seit 1998. Einer der besterhaltensten Industriebauten der Region.',
    risk: 'MITTEL',
    ndvi: 0.48, ndwi: 0.07,
    youtube_script: {
      hook: 'Sechs Stockwerke verlassene Industrie direkt am Fluss Segura.',
      act1: '1905: Dampfbetriebene Produktion für die ganze Region Orihuela.',
      act2: '1963: Supermarkt-Mehl macht Dampfmühlen unrentabel.',
      act3: 'Heute: Eiserne Mahlwerke rosten im sechsstöckigen Backsteinturm.'
    },
    safety_info: {
      structural: 'Eisenträger verrostet. Mehlstaub-Explosionsgefahr beachten.',
      legal: 'Industriedenkmal. Stadtrat Orihuela – Besichtigung anfragen.',
      equipment: 'P3-Staubmaske, Helm & Sicherheitsschuhe.'
    }
  },
  {
    id: 6,
    name: 'Reisfabrik & Harinera Sueca Ruine',
    lat: 39.2045, lon: -0.3125,
    province: 'Valencia', type: 'Industriegebäude / Fabrik Ruine',
    status: 'UNCHARTED_NEW_DISCOVERY',
    year: 1912, built_area: '4.800 m²',
    catastro_ref: '46235A009000110000DD',
    isIllustration: true,
    image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=800&q=80',
    source_url: 'https://es.wikipedia.org/wiki/Sueca',
    history: 'Alte Weinkellerei und Reisfabrik in der Reisebene von Sueca. 1912 erbaut, nach der Mechanisierung der Landwirtschaft in den 1960er Jahren stillgelegt. Gewaltige Backstein-Silos sind noch vollständig erhalten.',
    risk: 'MITTEL',
    ndvi: 0.51, ndwi: 0.08,
    youtube_script: {
      hook: 'Die verlassene Giganten-Fabrik in den Reisfeldern von Valencia.',
      act1: '1912: Blütezeit der Reis- & Weinexporte.',
      act2: '1965: Mechanisierung stoppt den Manufaktur-Betrieb.',
      act3: 'Heute: Gewaltige Silos und Backstein-Hallen.'
    },
    safety_info: {
      structural: 'Stahlträger verrostet, Schutthaufen im Hof.',
      legal: 'Gewerbliches Brachland.',
      equipment: 'P2-Staubmaske & Sicherheitsschuhe.'
    }
  },
  {
    id: 7,
    name: 'Fábrica de Cerámica Manises (Azulejo-Fabrik)',
    lat: 39.4889, lon: -0.4602,
    province: 'Valencia', type: 'Verlassene Keramikfabrik',
    status: 'KNOWN_HISTORIC_SITE',
    year: 1923, built_area: '7.500 m²',
    catastro_ref: '46159A008000120000II',
    isIllustration: true,
    image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=800&q=80',
    source_url: 'https://es.wikipedia.org/wiki/Manises',
    history: 'Monumentale Keramikfabrik in Manises – dem Weltzentrum valencianischer Azulejos. 1923 erbaut, Brennöfen bis 4 Meter Höhe noch intakt. 1989 nach Billigimporten aus Asien geschlossen. Fabrikgelände mit riesigem Tonbestand und historischen Brennöfen.',
    risk: 'MITTEL',
    ndvi: 0.44, ndwi: 0.05,
    youtube_script: {
      hook: 'Riesige Brennöfen in der verlassenen Azulejo-Fabrik von Manises.',
      act1: '1923: Manises beliefert ganz Europa mit bemalten Fliesen.',
      act2: '1989: Billigimporte aus Asien machen die Produktion unmöglich.',
      act3: 'Heute: 4 Meter hohe Brennöfen stehen verlassen zwischen Tonstapeln.'
    },
    safety_info: {
      structural: 'Betonbau solide. Achtung: Asbestdämmung an Öfen möglich.',
      legal: 'Privates Industriegelände.',
      equipment: 'FFP3-Maske & Schutzanzug.'
    }
  },
  ...
  {
    id: 8,
    name: 'Pueblo Fantasma Macisvenda',
    lat: 38.2791, lon: -1.0245,
    province: 'Alicante', type: 'Komplett verlassenes Dorf',
    status: 'UNCHARTED_NEW_DISCOVERY',
    year: 1752, built_area: '22.000 m²',
    catastro_ref: '03082A001000110000MM',
    isIllustration: true,
    image: 'https://images.unsplash.com/photo-1472457897821-70d3819a0e24?auto=format&fit=crop&w=800&q=80',
    source_url: 'https://es.wikipedia.org/wiki/Macisvenda',
    history: 'Komplett verlassenes Dorf aus dem 18. Jh. an der Grenze zu Murcia. Alle Einwohner verließen Macisvenda in den 1960ern. Kirche, Rathaus, Schule, Taverne und über 60 Wohnhäuser stehen leer. Offiziell dokumentiert und im Kataster eingetragen.',
    risk: 'NIEDRIG',
    ndvi: 0.45, ndwi: 0.02,
    youtube_script: {
      hook: 'Ein ganzes Dorf verlassen: 60 Häuser – und kein einziger Bewohner.',
      act1: '1752: Gründung des Dorfes auf dem Hochplateau.',
      act2: '1960er: Abwanderung in Industriestädte – Dorf stirbt innerhalb eines Jahrzehnts.',
      act3: 'Heute: Kirchenglocken rosten, Schultafeln hängen noch an der Wand.'
    },
    safety_info: {
      structural: 'Lehmziegelhäuser – viele Dächer eingestürzt. Vorsicht!',
      legal: 'Öffentliches Dorf (Gemeinde Abanilla). Begehung möglich.',
      equipment: 'Helm & festes Schuhwerk.'
    }
  },

  // ─── BURGEN & HISTORISCHE BAUTEN ─────────────────────────────────────────────
  {
    id: 9,
    name: 'Castillo de Petrer (Moorische Burg, 1192)',
    lat: 38.4762, lon: -0.7638,
    province: 'Alicante', type: 'Mittelalterliche Burg / Kastell',
    status: 'KNOWN_HISTORIC_SITE',
    year: 1192, built_area: '4.100 m²',
    catastro_ref: '03104A002000110000SS',
    isIllustration: true,
    image: 'https://images.unsplash.com/photo-1548783300-b6f5f1b2a6c2?auto=format&fit=crop&w=800&q=80',
    source_url: 'https://es.wikipedia.org/wiki/Castillo_de_Petrer',
    history: 'Mittelalterliche Burg aus dem 12. Jahrhundert in Petrer (Qasr Batruh, 1192). Moorische Ursprünge, später kastilisch umgebaut. Seit dem 20. Jh. unbewohnt, Türme teilweise einsturzgefährdet. Offiziell als BIC-Denkmal klassifiziert.',
    risk: 'HOCH',
    ndvi: 0.38, ndwi: 0.02,
    youtube_script: {
      hook: 'Die vergessene Burg: 800 Jahre Geschichte über der Schuhstadt Petrer.',
      act1: '1192: Mouros bauen Qasr Batruh auf dem Felsvorsprung.',
      act2: '1492: Reconquista – Kastilier übernehmen die Festung.',
      act3: 'Heute: Bröckelnde Türme, Feigenbäume wachsen aus den Ruinen.'
    },
    safety_info: {
      structural: 'HOCH: Mittelalterliches Mauerwerk, sehr bröckelig.',
      legal: 'BIC-Denkmal. Zugang über Ayuntamiento Petrer.',
      equipment: 'Helm PFLICHT & robuste Bergschuhe.'
    }
  },
  ...
  {
    id: 10,
    name: 'Balneario de Cofrentes (Thermalhotel, 1912)',
    lat: 39.2295, lon: -1.0682,
    province: 'Valencia', type: 'Verlassenes Thermalbad & Hotel',
    status: 'UNCHARTED_NEW_DISCOVERY',
    year: 1912, built_area: '7.800 m²',
    catastro_ref: '46098A004000330000PP',
    isIllustration: true,
    image: 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?auto=format&fit=crop&w=800&q=80',
    source_url: 'https://es.wikipedia.org/wiki/Cofrentes',
    history: 'Monumentales Thermalhotel am Júcar-Fluss. 1912 erbaut, in den 1920ern das beliebteste Thermalbad der valencianischen Bourgeoisie. Seit 1981 geschlossen. 200 Zimmer, Badehalle mit antiken Marmorbecken noch erhalten. Im Kataster als historisches Denkmal.',
    risk: 'MITTEL',
    ndvi: 0.56, ndwi: 0.19,
    youtube_script: {
      hook: 'Die versunkene Pracht: Thermalbad Cofrentes und seine Marmorbecken.',
      act1: '1912: Dampfbäder und Kurpackungen für die Bourgeoisie.',
      act2: '1981: Modernisierungskosten übersteigen den Betrieb.',
      act3: 'Heute: Antike Marmorbecken verwittern am Júcar-Flussufer.'
    },
    safety_info: {
      structural: 'Feuchte Mauern, Keller überschwemmt.',
      legal: 'Gemeindeeigentum Cofrentes. Außenansicht möglich.',
      equipment: 'Gummistiefel & Taschenlampe.'
    }
  },
  ...
  {
    id: 11,
    name: 'Manicomio Provincial de Valencia (Psychiatrie)',
    lat: 39.4632, lon: -0.3924,
    province: 'Valencia', type: 'Verlassene Psychiatrische Klinik',
    status: 'KNOWN_HISTORIC_SITE',
    year: 1878, built_area: '18.500 m²',
    catastro_ref: '46250A009000550000LL',
    isIllustration: true,
    image: 'https://images.unsplash.com/photo-1516574187841-cb9cc2ca948b?auto=format&fit=crop&w=800&q=80',
    source_url: 'https://es.wikipedia.org/wiki/Hospital_Psiqui%C3%A1trico_de_Valencia',
    history: 'Ehemaliges Manicomio Provincial Valencia – einer der größten verlassenen Psychiatrie-Komplexe Spaniens. 1878 erbaut im Pavillon-System für 1.200 Patienten. 1988 durch Psychiatriereform geschlossen. 14 Pavillons auf 18.500 m², dokumentiert in diversen Urbex-Archiven.',
    risk: 'HOCH',
    ndvi: 0.53, ndwi: 0.14,
    youtube_script: {
      hook: 'Das größte verlassene Irrenhaus Spaniens – 14 Pavillons im Dunkel.',
      act1: '1878: Pavillon-System nach Kirburne für 1.200 Patienten.',
      act2: '1988: Psychiatriereform – alle Patienten werden verlegt.',
      act3: 'Heute: 14 verlassene Pavillons mit altem medizinischen Equipment.'
    },
    safety_info: {
      structural: 'Stabile Pavillon-Außenmauern, morsche Zwischenwände.',
      legal: 'Stadtrat Valencia – Abrissstreit läuft seit 2015.',
      equipment: 'Schutzhelm, P3-Maske, Taschenlampe.'
    }
  },
  ...
  {
    id: 12,
    name: 'Palau del Marquès de Dos Aguas (Vallterra)',
    lat: 39.4701, lon: -0.3745,
    province: 'Valencia', type: 'Verlassener Barockpalast / Adelsresidenz',
    status: 'KNOWN_HISTORIC_SITE',
    year: 1740, built_area: '6.200 m²',
    catastro_ref: '46250A010000220000VV',
    isIllustration: true,
    image: 'https://images.unsplash.com/photo-1551913902-c92207136625?auto=format&fit=crop&w=800&q=80',
    source_url: 'https://es.wikipedia.org/wiki/Palacio_del_Marqu%C3%A9s_de_Dos_Aguas',
    history: 'Prachtvoller Barockpalast aus dem 18. Jh. in Valencia, erbaut 1740. Berühmt für sein monumentales Alabasterportal. Teilbereiche sind museal erschlossen, hintere Flügel und Nebengebäude seit Jahrzehnten verlassen und im Verfall.',
    risk: 'NIEDRIG',
    ndvi: 0.29, ndwi: 0.03,
    youtube_script: {
      hook: 'Das Alabasterportal von Valencia: Barockpracht und Verfall.',
      act1: '1740: Marqués lässt das üppigste Stadtpalais Valencias bauen.',
      act2: '1952: Letzte Adelige verlässt die hinteren Gemächer.',
      act3: 'Heute: Alabasterportal leuchtet – dahinter verfallen Prunkräume.'
    },
    safety_info: {
      structural: 'Hintere Flügel instabil. Vorderbereich zugänglich.',
      legal: 'Teils Museo Nacional de Cerámica. Innenhof frei.',
      equipment: 'Keine Sonderausrüstung nötig für Außenbereich.'
    }
  }
];
